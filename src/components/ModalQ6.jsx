...
import img6 from "../assets/img/quadro (6).jpg";
      ...
      >
        <Modal.Header closeButton className="minhaModal">
          <Modal.Title id="example-custom-modal-styling-title">
            Composição VIII
            <span className="ocultaSpan"> - Wassily Kandinsky</span>
          </Modal.Title>
        </Modal.Header>
        <Modal.Body className="minhaModal">
          <div className="row">
            <div className="col-12 col-md-12 col-lg-5">
              <img src={img6} alt="fotos da galleria 1" className="img-fluid" />
            </div>
